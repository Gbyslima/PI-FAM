...
<div class="form-container">
  <h2>Editar</h2>
  <form action="dbpacientes.php" method="POST">
    ...
    <input type="date" name="data_nascimento" id="data_nascimento" value="<?php echo htmlspecialchars($data_nascimento); ?>" required>
    ...
    <button type="button" onclick="window.location.href='paciente.php'">Voltar</button>
  </form>
</div>
