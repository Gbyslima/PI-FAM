...
if (!empty($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
      while($user_data = $result->fetch_assoc()) {
        $id = $user_data['id'];
        $nome = $user_data['nome'] ?? '';
        $servico = $user_data['servico'] ?? null;
...
<head>
  <meta charset="UTF-8" />
  <title>Ordem de serviços - Editar</title>
...
<div class="form-container">
  <h2>Editar</h2>
  <form action="dbordemdeservico.php" method="post">
    ...
    <input type="number" name="preco" placeholder="Preço" value="<?php echo htmlspecialchars($preco); ?>" required>

    <input type="text" name="responsavel" id="Eesponsavel" value="<?php echo htmlspecialchars($responsavel); ?>" required>

     <input type="date" name="data" id="data" value="<?php echo htmlspecialchars($data); ?>" required>

    <input type="time" name="hora" id="hora" value="<?php echo htmlspecialchars($hora); ?>" required>
    ...
    <button type="button" onclick="window.location.href='ordemdeservico.php'">Voltar</button>
  </form>
</div>
